    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_school', models.CharField(blank=True, max_length=135, verbose_name='博士学校')),
                ('major', models.CharField(blank=True, max_length=135, verbose_name='专业')),
                ('degree', models.CharField(blank=True, choices=[('本科', '本科'), ('研究生', '研究生'), ('博士', '博士')], max_length=135, verbose_name='学历')),
                ...
                ('first_learning_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='学习能力得分')),
                ('first_professional_competency', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='专业能力得分')),
                ...
                ('second_learning_ablity', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='学习能力得分')),
                ...
                ('second_davantage', models.TextField(blank=True, max_length=1024, verbose_name='优势')),
                ...
                ('second_recommend_position', models.CharField(blank=True, max_length=256, verbose_name='建议方向或者推荐部门')),
                ...
                ('hr_porential', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR发展潜力')),
